...
Route::prefix("admin")->middleware('role:3')->group(function () {
    ...
    // Route::get("/login/owner", [AdminController::class, ""])->name("admin.login");
    // Route::get("/dashboard", [AdminController::class, "Dashboard"])->name("admin.dashboard");
});

Route::prefix("operatorius")->middleware('role:2')->group(function () {
...
//     Route::get("/", [PackageController::class, "index"])->name("package.show-all");
//     Route::get("/create", [PackageController::class, "UserController@createPackage"])->name("package.create");
//     Route::post("/create", [PackageController::class, "UserController@sendPackage"])->name("package.send");
// });

Route::prefix("klientas")->middleware('role:1')->group(function () {
